...
$script = "Joomla.submitbutton = function(task)
        {
                        if (task == 'sofa.cancel' || document.formvalidator.isValid(document.id('sofa-form'))) {";
$script .= "    Joomla.submitform(task, document.getElementById('sofa-form'));
                                if (self != top) {
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_filauti&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="sofa-form" class="form-validate">
