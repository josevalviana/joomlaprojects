 ...
 * @since 1.7
 */
class HospitalsViewEquipment extends JView {
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar() {
		...
		JToolBarHelper::title(JText::_('COM_HOSPITALS_MANAGER_EQUIPMENT'), 'hospitals-equipments');
		...
		JToolBarHelper::help('JHELP_COMPONENTS_HOSPITALS_EQUIPMENTS_EDIT');
	}
}